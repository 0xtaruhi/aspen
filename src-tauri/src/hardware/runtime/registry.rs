...
use super::input::{
    compile_bitset_input, compile_quadrature_encoder_input, compile_single_bit_input,
    compile_uart_terminal_input, InputDeviceEncoder,
};
use super::output::{
    ...
    compile_uart_terminal_output, compile_vga_display_output, OutputDeviceDecoder,
};
