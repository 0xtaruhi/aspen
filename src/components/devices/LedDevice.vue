...
const glowColor = computed(() => {
    switch (props.color) {
        ...
        default: return 'rgba(239, 68, 68, 0.6)' // Default red
    }
})
...
<template>
    <div class="w-full h-full flex items-center justify-center">
        <div 
            ...
            :class="[
                isOn ? baseColor : 'bg-zinc-800',
                isOn ? 'shadow-[0_0_15px_rgba(0,0,0,0.5)]' : ''
            ]"
            :style="{ boxShadow: isOn ? `0 0 20px ${glowColor}` : 'none' }"
        >
