...
export function createHardwareStoreView() {
  ...
  return {
    ...
    waveformTrackedSignals: hardwareRuntimeStore.waveformTrackedSignals,
    waveformTracks: hardwareRuntimeStore.waveformTracks,
    waveformRevision: hardwareRuntimeStore.waveformRevision,
    waveformSampleRateHz: hardwareRuntimeStore.waveformSampleRateHz,
    waveformLastSequence: hardwareRuntimeStore.waveformLastSequence,
